...
public class CRUDGruposAsignaturaSuiteIT {
	...
	public void deleteGruposAsignaturaIT() {
		...
		driver.findElement(By.cssSelector("li")).click();
		assertEquals(driver.findElement(By.cssSelector("li")).getText(), ("Grupo-Asignatura eliminado correctamente"));
		driver.findElement(By.name("j_idt6:j_idt21")).click();
		driver.findElement(By.cssSelector("body")).click();
		assertEquals(driver.findElement(By.cssSelector("li")).getText(), ("No se ha podido leer el grupo-asignatura"));
	}
